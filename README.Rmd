...
The function "get_scaling_params_Intensity" returns a data frame of scaling parameters for each season and a list of plots for showing empirical estimates and fitted scaling models.
