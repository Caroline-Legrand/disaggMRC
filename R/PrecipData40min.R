#' @title Precipitation data set observed at 40-minute resolution
#'
#' @description Example of a 40-year precipitation time series observed at a station in Switzerland with a resolution of 40 minutes
#' 
