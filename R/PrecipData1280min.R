#' @title Precipitation data set observed at 1280-minute resolution
#'
#' @description Example of a 40-year precipitation time series observed at a station in Switzerland with a resolution of 1280 minutes
#' 
