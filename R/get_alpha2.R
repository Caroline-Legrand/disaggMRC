#' get_alpha2
#' 
#' @description A function that estimates the parameter \eqn{\alpha_{2}} of the Beta distribution given the parameter \eqn{\alpha} of the symmetric Beta distribution and its mean
#' 
...
#' 
#' @return A numerical value, the parameter \eqn{\alpha_{2}} of the Beta distribution
#' 
...
get_alpha2 = function(alpha, m){
  ...
  # The alpha2 parameter of the non-symmetric Beta distribution
